...
namespace LoanPledgingTool
{
	public class Startup
	{
		...
		public void ConfigureServices(IServiceCollection services)
		{
			...
			services.Configure<AwsConfig>(Configuration.GetSection("nf.platform.utility.aws"))
				.AddSingleton<ISsmService<DbCredentials>, SsmService<DbCredentials>>();

			var sp = services.BuildServiceProvider();
			var ssmService = sp.GetService<ISsmService<DbCredentials>>();
			var apolloConnectionString = ssmService.Credentials?.ConnectionStrings?.Apollo;
